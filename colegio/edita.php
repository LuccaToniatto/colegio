<?php
    ...
    $prova2 = $_POST['nota2'];
    $pessoa[$posicao] = $nome;
    $pessoa[$posicao+1] = $prova1;
    $pessoa[$posicao+2] = $prova2;

    unlink("informa.txt");
    rename("informa2.txt","informa.txt");
                ...
                <div class="row justify=content-center row-cols-2 row-cols-md-1 mb-3 text-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                <h1><b><center>Nota editada com sucesso!</center></b></h1>
                            </div>
                        </div>
                    </div>
                </div>
