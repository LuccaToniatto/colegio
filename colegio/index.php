                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <h3 class="my-0 fw-normal">&nbsp;<b>- Painel do professor -</b><h3> <br> <button type="button" class="btn btn-outline-dark"><h4><b><a href="cadastro.php?">Cadastrar aluno</a></b></h4></button>
                            </div>
                            <div class="card-body">
                                <?php
                                    include 'matriz.php';
