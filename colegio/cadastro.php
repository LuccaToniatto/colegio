                ...
                <div class="row justify=content-center row-cols-2 row-cols-md-1 mb-3 text-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                                <div class="card-header py-3" style="background-color:#212529">
                                    <h3 class="my-0 fw-normal">&nbsp;<b><font color="#ffffff">Cadastrando Aluno</b></font><h3>
                            </div>
                            <div class="card-body">
                                    <div class="container-fluid" style="background-color:#212529">
                                    <center><h3><b><font color="#ffffff">- Insira as notas das provas -</font></b></h3></center>
                                    </div>
                                <?php

                                    include 'notascampos.php';
                                ...
                                <div class="container">
                                    <?php
                                        if(isset($_POST['nota4'])){
                                            ...
                                            $nota3=$_POST['nota3'];
                                            $nota4=$_POST['nota4'];
                                            echo('<b>Prova n1: </b>'.$nota1.'</br>');
                                            echo('<b>Prova n2: </b>'.$nota2.'</br>');
                                            echo('<b>Prova n3: </b>'.$nota3.'</br>');
                                            echo('<b>Prova n4: </b>'.$nota4.'</br>');
                                        }
                                    ?>
                                </div>
                            </div>
