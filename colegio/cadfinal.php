                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <h3 class="my-0 fw-normal">&nbsp;<b>- Cadastrando Aluno -</b><h3>
                            </div>
                            <div class="card-body">
                                <?php
                                    echo"<b>Nome: </b></hr></br>".$dados['nome']."<br/>";
                                    echo"<b>Prova n1: </b></hr></br>".$dados['nota1']."<br/>";
                                    echo"<b>Prova n2: </b></hr></br>".$dados['nota2']."<br/>";
                                    echo"<b>Media: </b></hr></br>".$dados['media']."<br/>";
                                ?>
                            </div>
                            <button type="button" class="btn btn-outline-dark"><h4><b><a href="index.php?">Confirmar Cadastro</a></b></h4></button>
                        </div>
                    </div>
                </div>
            </section>
